...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    {
        /// <summary>
        /// Lets Holoplay components drive the Focus and Apeture values
        /// </summary>
        [Min(0.0001f), Tooltip("Lets Holoplay components drive the Focus and Apeture values.")]
        public BoolParameter holoplayDrivenFocus = new BoolParameter { value = true };

        /// <summary>
        /// The intensity of the DOF effect as driven by the Holoplay Capture
        /// </summary>
        [Min(0.0001f), Tooltip("The intensity of the DOF effect as driven by the Holoplay Capture.")]
        public FloatParameter holoplayIntensity = new FloatParameter { value = 10f };
        ...
        /// </summary>
        [Range(0.0001f, 3200f), Tooltip("Ratio of aperture (known as f-stop or f-number). The smaller the value is, the shallower the depth of field is.")]
        ...
        /// depth of field is.
        /// </summary>
        [Range(.0001f, 30000f), Tooltip("Distance between the lens and the film. The larger the value is, the shallower the depth of field is.")]
        ...
        public KernelSizeParameter kernelSize = new KernelSizeParameter { value = KernelSize.VeryLarge };
